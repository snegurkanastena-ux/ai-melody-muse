  ...
  <section className="py-24">
    <div className="container">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Последнее обновление: [дата]</p>
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-secondary-foreground">
          <div>
            ...
            <p className="mt-3">Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сайта MELANØ (далее — «Сайт»), принадлежащего [ФИО / наименование ИП / юридического лица] (далее — «Оператор»).</p>
          ...
          <div>
            ...
            <p className="mt-2">Персональные данные хранятся в течение срока, необходимого для достижения целей обработки, но не менее [срок] с момента последнего взаимодействия.</p>
          </div>

          <div>
            <h2 className="font-display text-xl font-semibold text-foreground">5. Права пользователя</h2>
            <p className="mt-3">Пользователь имеет право запросить информацию о своих персональных данных, потребовать их исправления или удаления, направив запрос на адрес: [email].</p>
          </div>

          <div>
            <h2 className="font-display text-xl font-semibold text-foreground">6. Контакты оператора</h2>
            <p className="mt-3">[ФИО / наименование]</p>
            <p>[адрес]</p>
            <p>Email: [email]</p>
            <p>ИНН: [ИНН]</p>
          </div>
