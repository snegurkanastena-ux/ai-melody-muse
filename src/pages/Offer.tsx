      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-secondary-foreground">
          <div>
            ...
            <p className="mt-3">Настоящая оферта определяет условия оказания цифровых творческих услуг (создание песен, текстов, музыки, аранжировок, джинглов и иных музыкальных продуктов) Исполнителем — [ФИО / наименование] (далее — «Исполнитель») — Заказчику, оформившему заявку через Сайт.</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3">Стоимость услуг указана на Сайте и может быть уточнена индивидуально. Оплата производится в порядке, согласованном сторонами. Исполнитель вправе требовать предоплату в размере [__]% от стоимости заказа.</p>
          </div>
